...
|:------:|:--------:|:--------|
| Organisation | org | - "organisationid"<br>- "assetid"<br>- "organisationcode"<br>- "organisationname"<br>- "statecode"<br>- "statename"<br>- "regionname"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "lpcode" |
| Site | site | - "siteid"<br>- "organisationid"<br>- "assetid"<br>- "sitecode"<br>- "sitename"<br>- "state"<br>- "regionname"<br>- "statecode"<br>- "statename"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "lpcode" |
| Building | building | - "buildingid"<br>- "siteid"<br>- "assetid"<br>- "buildingcode"<br>- "buildingname"<br>- "address"<br>- "suburb"<br>- "state"<br>- "postcode"<br>- "lng"<br>- "lat"<br>- "constructionyear"<br>- "sitesize"<br>- "regionname"<br>- "statecode"<br>- "statename"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "lpcode" |
| Level | level | - "levelid"<br>- "buildingid"<br>- "assetid"<br>- "leveloptionid"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "longname"<br>- "shortname"<br>- "leveloptioncode"<br>- "lpcode" |
| Room | room | - "roomid"<br>- "levelid"<br>- "assetid"<br>- "roomcode"<br>- "roomname"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "lpcode" |
| Object | object | - "assetobjectid"<br>- "roomid"<br>- "assetid"<br>- "assetobjectcode"<br>- "assetobjectname"<br>- "insertbyname"<br>- "lasteditedname"<br>- "insertdate"<br>- "lastupdate"<br>- "lpcode" |
